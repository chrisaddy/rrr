...
#' Residuals of Reduced-Rank Regression
#' 
#' \code{rrr_residual} calculates residuals of a reduced-rank regression model.
#'
#' @inheritParams rrr
#'
...
#' rrr_residual(tobacco_x, tobacco_y, gamma, rank = 1)
#'
#' @references Izenman, A.J. (2008) \emph{Modern Multivariate Statistical Techniques}. Springer.
#'
#' @export

rrr_residual <- function(x, y, gamma_matrix, rank = "full", type = "cov", k = 0){
