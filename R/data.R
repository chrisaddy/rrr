...
#'
#' @format a data frame with 10992 observations on 36 unnamed variables
#'
#' @source \url{http://archive.ics.uci.edu/ml/datasets.html}
...
#'
#' @format A data frame with 3462 observations on 65 numeric variables.
#' 
#' @references A. Izenman (2008). \emph{Modern Multivariate Statistical Techniques}. Springer.
#' @references Wolf, C. Meisenheimer, M., Kleinheinrich, M., Borch, A., Dye, S., Gray, M., Wisotski, L., Bell, E.F., Rix, H., W. Cimatti, A., Hasinger, G., and Szokoly, G. (2004). \emph{A catalogue of the Chandra Deep Field South with multi-colour classification and photometric redshifts from COMBO-17, Astronomy & Astrophysics}. \url{arXiv:astro-ph/0403666v1}
"COMBO17"
