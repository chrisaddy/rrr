...
```{r}
rank_trace_plot(tobacco_x, tobacco_y, gamma1, interactive = TRUE)

rank_trace_plot(tobacco_x, tobacco_y, gamma2, interactive = TRUE)
```
...
```{r}
cva_rank_trace_plot(galaxy_x, galaxy_y, interactive = TRUE)
```
