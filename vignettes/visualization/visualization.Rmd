...
pairwise_plot(iris_features, iris_class, type = "lda")
```
...
pairwise_plot(galaxy_x, galaxy_y, type = "cva", pair_x = 2, interactive = TRUE)
pairwise_plot(iris_features, iris_class, type = "lda", interactive = TRUE)
```
